## 안녕하세요, 융합 엔지니어를 꿈꾸는 박지훈입니다.

**기계공학** 전공 지식으로 현상에 대한 깊이 있는 이해를 갖추고, **AI/소프트웨어** 역량으로 이를 해결하는 엔지니어가 되기를 희망합니다.

성균관대학교 대학원 진학을 통해 **딥러닝(PyTorch/TensorFlow) 기반의 융합 연구**를 주력할 예정입니다.
